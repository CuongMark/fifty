...
class Collection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    ...
    protected function _initSelect()
    {
        ...
        $this->addFilterToMap('start_pot', 'product.start_pot');
        $this->addFilterToMap('winning_prize', 'prize.winning_prize');
        $this->addFilterToMap('winning_number', 'prize.winning_number');
        parent::_initSelect();
        $this->_joinFields();
        $this->_addFilters();
        return $this;
...
//        $this->ticketManagement->joinProductName($this);
        $this->ticketManagement->joinNameAndStartPot($this);
    ...
    function addFilter($field, $value, $type = 'and')
    {
